...
class CurrencyResource extends JsonResource
{
    ...
    public function __construct($resource, int $averageExchangeRate = 0)
    {
    ...
    ): array
    {
        return [
            'id' => $this->id,
            'name' => $this->name,
            'amountTotal' => $this->when($this->averageExchangeRate , $this->transactions()->sum('amount')),
            'averageExchangeRate' => $this->when($this->averageExchangeRate, $this->averageExchangeRate),
